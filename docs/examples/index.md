...
The repository of ETHOS.FINE provides a number of different examples to get to know the package.
...
| Example | Description |
|---|---|
| [00 Tutorial](00_Tutorial/00_Tutorial.ipynb) | An energy supply system, consisting of two regions, is modeled and optimized. **Recommended as starting point** to get to know ETHOS.FINE. |
| [01 1-node Energy System](01_1node_Energy_System_Workflow/01_1node_Example.ipynb) | A single region energy system is modeled and optimized. The system includes only a few technologies. |
...
| [11 Scheduled Maintenance](11_Scheduled_Maintenance/11_Scheduled_Maintenance.ipynb) | Shows how to schedule and visualize multiple independent maintenance windows for a dynamic conversion component. |
