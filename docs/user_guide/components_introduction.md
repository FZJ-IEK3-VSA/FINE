...
classes, `Storage` class, `Conversion` class, `Transmission` class). Shared features of these components are
provided in the `Component` class. The actual optimization problem is created in the `EnergySystemModel` class.

It is important to have a clear idea of what you know about your energy system beforehand and what you want to
optimize. Two types of "values" must be distinguished:
