...
In FINE latest release (1.2) the following functionalities were included, for example:
...
* A two-stage approach to reduce computation time of MILPs with time series aggregation, while providing a lower and upper error bound (Kanngießer et al. (2020) https://www.mdpi.com/1996-1073/12/14/2825)
