...
wind_investPerCapacity = aggregated_esM.getComponentAttribute(
    "Wind (onshore)", "investPerCapacity"
).mean()
wind_opexPerCapacity = aggregated_esM.getComponentAttribute(
    "Wind (onshore)", "opexPerCapacity"
).mean()
wind_interestRate = aggregated_esM.getComponentAttribute(
    "Wind (onshore)", "interestRate"
).mean()
wind_economicLifetime = aggregated_esM.getComponentAttribute(
    "Wind (onshore)", "economicLifetime"
).mean()

pv_investPerCapacity = aggregated_esM.getComponentAttribute(
    "PV", "investPerCapacity"
).mean()
pv_opexPerCapacity = aggregated_esM.getComponentAttribute(
    "PV", "opexPerCapacity"
).mean()
pv_interestRate = aggregated_esM.getComponentAttribute("PV", "interestRate").mean()
pv_economicLifetime = aggregated_esM.getComponentAttribute(
    "PV", "economicLifetime"
).mean()
