...
def test_TSAmultiStage(minimal_test_esM):
    ...
    electrolyzers.investIfBuilt[0] = pd.Series(2e5, index=esM.locations)
    pressureTank.investIfBuilt[0] = pd.Series(1e5, index=esM.locations)
    pipelines.investIfBuilt[0].loc[:] = 100
