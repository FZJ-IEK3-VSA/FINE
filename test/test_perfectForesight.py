...
def test_perfectForesight():
    ...
    assert list(esM.componentModelingDict["SourceSinkModel"].operationVariablesOptimum[0].xs('EDemand').values[0]) == [2000,1000,1000,1000]
    assert list(esM.componentModelingDict["SourceSinkModel"].operationVariablesOptimum[1].xs('EDemand').values[0]) == [2000,1000,1000,1000]
