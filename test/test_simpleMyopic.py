...
def test_exceededLifetime(minimal_test_esM):
    # load a minimal test system
    esM= minimal_test_esM

    # Set the technical lifetime of the electrolyzers to 7 years.
    setattr(esM.componentModelingDict['ConversionModel'].componentsDict['Electrolyzers'], 'technicalLifetime', pd.Series([7,7], index=esM.locations))
