...
def test_perfectForesight_mini(perfectForesight_test_esM):
    ...
    np.testing.assert_almost_equal(expected_obj,output_obj_dict), "The expected objective value and the output objective value differ"
    ...
    # test if objective values are the same
    np.testing.assert_almost_equal(expected_obj,output_obj_xarray), "The expected objective value and the output objective value differ"