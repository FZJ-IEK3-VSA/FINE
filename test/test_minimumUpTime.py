...
def test_minimumUpTime():
    ...
    esM.add(fn.ConversionFancy(esM=esM, name='restricted', physicalUnit=r'GW$_{el}$',
                          commodityConversionFactors={'electricity':1, 'methane':-1/0.625},
                          capacityFix = data_cap, partLoadMin = 0.3, bigM= 100, upTimeMin=4,
                          investPerCapacity=0.5, opexPerCapacity=0.021, opexPerOperation =1, interestRate=0.08,
                          economicLifetime=33))

    data_demand = {'example_region1': [5,5,2,2,4,5,5,2,2,4,5,5,4,2,4,5,5,2,2,4], 'example_region2': [5,5,2,2,4,5,5,2,2,4,5,5,2,2,4,5,5,2,2,4]}
