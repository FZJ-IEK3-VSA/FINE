...
def compare_values(value_1, value_2):
    ...
    if isinstance(value_1, DataFrame) and isinstance(value_2, DataFrame):
        ...
        value_1.index = value_1.index.set_names(
            names=[None] * number_of_index_level_value_1
        )

        number_of_index_level_value_2 = value_2.index.nlevels
        value_2.index = value_2.index.set_names(
            names=[None] * number_of_index_level_value_2
        )

        value_1.columns = value_1.columns.set_names(names=[None])
        value_2.columns = value_2.columns.set_names(names=[None])
        ...
        value_1.index = value_1.index.set_names(names=[None])
        value_2.index = value_2.index.set_names(names=[None])
