...
def test_segmentation(minimal_test_esM):
    ...
    esM1 = copy.deepcopy(minimal_test_esM)
    ...
    # copy.deepcopy nutzen evtl? See: https://docs.python.org/3/library/copy.html
    esM2 = copy.deepcopy(minimal_test_esM)
    ...
    assert abs(esM1.pyM.Obj() - esM2.pyM.Obj()) < 0.0000001
    ...
    esM3 = copy.deepcopy(minimal_test_esM)
    ...
    esM4 = copy.deepcopy(minimal_test_esM)
    ...
    assert abs(esM3.pyM.Obj() - esM4.pyM.Obj()) < 0.0000001
