...
def test_miniSystem():
    ...
    np.testing.assert_almost_equal(summary.loc[("Electricity demand", "TAC", "[Euro/a]"), "loc1"] , -730)
    np.testing.assert_almost_equal(summary.loc[("Electricity demand", "TAC", "[Euro/a]"), "loc2"] , -2920)
    np.testing.assert_almost_equal(summary.loc[("Electricity purchase", "TAC", "[Euro/a]"), "loc1"] , 730)
    np.testing.assert_almost_equal(summary.loc[("Electricity purchase", "TAC", "[Euro/a]"), "loc2"] , 2920)
