...
def test_rasterize_xr_ds(gridded_RE_data, sample_shapefile):
    ...
    #Function call
    rasterized_RE_ds = RE_rep_utils.rasterize_xr_ds(gridded_RE_data, 
                                                    'SRS',
                                                    sample_shapefile, 
    ...
    #Assertion 
    np.testing.assert_equal(rasterized_RE_ds['rasters'].loc['reg_01',:,:].values, expected_raster_reg01)
    np.testing.assert_equal(rasterized_RE_ds['rasters'].loc['reg_02',:,:].values, expected_raster_reg02)
