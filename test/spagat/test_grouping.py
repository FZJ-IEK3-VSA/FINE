...
def test_perform_distance_based_grouping():
    ...
    output_dict = spg.perform_distance_based_grouping(
        dummy_ds, save_path=path_to_test_dir, fig_name=file_name
    )
...
def test_perform_parameter_based_grouping(
    weights, expected_region_groups, xr_for_parameter_based_grouping
):
    ...
    output_dict = spg.perform_parameter_based_grouping(
        xr_for_parameter_based_grouping, weights=weights
    )
